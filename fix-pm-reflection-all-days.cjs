// Fix PM Reflection visibility for all days in daily_plan_v1
...
let serviceAccount;
try {
  serviceAccount = require('./leaderreps-pd-platform-firebase-adminsdk.json');
} catch {
  console.log('Production credentials not found, trying test credentials');
  serviceAccount = require('./leaderreps-test-firebase-adminsdk-2n422-9e8249aba3.json');
}
