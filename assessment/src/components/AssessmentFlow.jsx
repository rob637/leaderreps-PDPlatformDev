...
import { ASSESSMENT_QUESTIONS, LEADERSHIP_DIMENSIONS } from '../data/questions';
    ...
    <div className="space-y-6">
      ...
      {value && (
        <motion.div
          ...
          className="text-center text-teal font-medium"
        >
          {labels[value - 1]}
        </motion.div>
      )}
...
const AssessmentFlow = ({ onComplete }) => {
  ...
  const getSectionLabel = () => {
    if (currentQuestion.section === 1) return "Leadership Scenarios";
        ...
        <div className="flex justify-between items-center gap-4">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3 rounded-xl font-semibold transition-all duration-200 ${
              isAnswered()
                ? 'bg-teal hover:bg-teal-light text-white shadow-lg hover:shadow-xl'
