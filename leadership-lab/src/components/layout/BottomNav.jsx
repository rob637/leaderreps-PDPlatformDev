import { MessageCircle, Scan, FlaskConical, Users, BookOpen, LayoutDashboard, Calendar, Settings } from 'lucide-react';
import { useNavigation } from '../../providers/NavigationProvider.jsx';
import { useAuth } from '../../hooks/useAuth.js';
import { USER_NAV_ITEMS, FACILITATOR_NAV_ITEMS } from '../../config/navigation.js';
...
export default function BottomNav() {
  ...
  const navItems = isFacilitator ? FACILITATOR_NAV_ITEMS : USER_NAV_ITEMS;
