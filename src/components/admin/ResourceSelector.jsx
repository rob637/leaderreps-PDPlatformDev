  ...
  return (
    <div className="relative">
      ...
      <div 
        ...
        className="flex items-center gap-2 p-2 border rounded-lg bg-white dark:bg-slate-800 hover:bg-slate-50 cursor-pointer transition-colors min-h-[38px]"
      >
        {selectedResource ? (
          <>
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 p-4">
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col">
            ...
            <div className="p-4 border-b flex items-center justify-between">
              <h3 className="font-bold text-lg text-slate-800 dark:text-slate-200">Select Resource</h3>
                    ...
                    return (
                      <div
                        ...
                        className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer transition-colors ${
                          isSelected ? 'bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800' : 'hover:bg-slate-50 border border-transparent'
                        }`}
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className={`text-sm font-medium ${isSelected ? 'text-teal-900' : 'text-slate-800 dark:text-slate-200'}`}>
                            {resource.title}
                          </p>
            ...
            {/* Footer - Create New */}
            <div className="p-3 border-t bg-slate-50 dark:bg-slate-800 flex justify-between items-center">
              <span className="text-xs text-slate-500 dark:text-slate-400">Can't find what you're looking for?</span>
              <a 
                href="/admin/content" 
                target="_blank" 
