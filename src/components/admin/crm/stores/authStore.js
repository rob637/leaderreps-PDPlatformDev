...
export const useAuthStore = create((set) => ({
  ...
  loading: false,
  error: null,
  isAuthorized: true, // When embedded in main app, user is already authorized

  // Set user from main app context (used when embedded)
  setUser: (userData) => {
  ...
  // Initialize auth listener (for standalone mode)
  initAuth: () => {
