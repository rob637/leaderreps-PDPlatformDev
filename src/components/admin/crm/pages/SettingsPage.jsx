          ...
          {apolloApiKey && creditsUsed > 0 && (
            <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              <div className="flex items-center gap-2 text-sm text-blue-700 dark:text-blue-300">
                ...
                <span><strong>{creditsUsed}</strong> searches/enrichments made through CRM</span>
              </div>
            </div>
          )}
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600 dark:text-slate-300 dark:text-slate-400">
                        Click "Create New Key", name it "CRM", and copy the key
                      </p>
                    </div>
                  </div>
        ...
        <div className="p-6 border-b dark:border-slate-700 bg-gradient-to-r from-red-50 to-rose-50 dark:from-red-900/20 dark:to-rose-900/20">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100">Outreach Gmail Accounts</h2>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="pt-4 border-t dark:border-slate-700">
            <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
              Connect @leaderreps.biz Gmail accounts for cold outreach. Each account can send emails through Outreach sequences.
            </p>
            <button
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-600 dark:text-slate-300 dark:text-slate-400">
                        Click the button above to authorize CRM to access your Gmail
                      </p>
                    </div>
                  </div>
