    ...
    <div className="p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-5 lg:space-y-6">
      ...
      <Card accent="ORANGE">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl sm:text-2xl font-bold mb-2" style={{ color: '#002E47' }}>
              Quick Edit Plan
            </h2>
          ...
          {hasChanges && (
            <div className="text-sm font-medium" style={{ color: '#E04E1B' }}>
              Unsaved changes
            </div>
          )}
        </div>
      ...
      {Object.entries(repsByArea).map(([area, reps]) => (
        <Card key={area} accent="ORANGE">
          <h3 className="font-bold mb-4" style={{ color: '#002E47' }}>
            {area}
          </h3>
            ...
            {reps.map((rep) => (
              ...
              >
                <div className="flex-1">
                  <div className="font-medium" style={{ color: '#002E47' }}>
                    {rep.skillName}
                  </div>
                  {rep.phase && (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="w-16 text-center">
                    <div className="font-bold" style={{ color: '#E04E1B' }}>
