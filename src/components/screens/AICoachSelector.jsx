    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="sticky top-0 z-10 bg-white border-b border-gray-100">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <h1 className="font-semibold text-gray-900">Choose Your AI Coach</h1>
      ...
      <main className="p-4 max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8 pt-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">AI Leadership Coaching</h2>
          <p className="text-gray-600">Two ways to develop your leadership skills</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-white rounded-2xl p-6 border-2 border-gray-100 hover:border-teal-300 
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold text-gray-900">Rep</h3>
          ...
          <button
            ...
            className="w-full bg-white rounded-2xl p-6 border-2 border-gray-100 hover:border-violet-300 
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between pr-12">
                  <h3 className="text-lg font-semibold text-gray-900">Reppy</h3>
        ...
        <div className="mt-8 bg-white rounded-xl p-4 border border-gray-100">
          <h4 className="font-medium text-gray-900 mb-3">Which is right for me?</h4>
          <div className="space-y-3 text-sm">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-gray-900">Choose Rep if...</p>
                <p className="text-gray-600">You're enrolled in a cohort and want guidance completing your Dashboard activities.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium text-gray-900">Choose Reppy if...</p>
                <p className="text-gray-600">You want a self-paced leadership program you can do anytime, with AI memory that learns about you.</p>
              </div>
            </div>
          </div>
        </div>
