        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 sm:p-8">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="w-full md:w-72 bg-slate-50 rounded-lg p-6 border border-slate-100 flex flex-col justify-center items-center text-center">
              ...
              <h3 className="font-bold text-slate-800 mb-2">Start This Workout</h3>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-grow min-w-0">
                    ...
                    <h4 className={`font-bold transition-colors ${isLocked ? 'text-slate-400' : 'text-slate-800 group-hover:text-orange-500'}`}>
                      {item.title}
                    </h4>
                    {item.description && (
