...
const Dashboard4 = () => {
  ...
  const scope = {
    ...
    setShowBreakdown: (val) => setShowBreakdown(val),
    onEditPlan: () => navigate('development-plan'),

    isFeatureEnabled,
    handleHabitCheck: (key, value) => handleHabitCheck(key, value),
    setIsAnchorModalOpen: (val) => setIsAnchorModalOpen(val),
    setIsCalendarModalOpen: (val) => setIsCalendarModalOpen(val),
    handleToggleAdditionalRep: (id, isChecked) => handleToggleAdditionalRep(id, isChecked),
    setMorningWIN: (val) => setMorningWIN(val),
    handleSaveWINWrapper: () => handleSaveWINWrapper(),
    handleToggleWIN: () => handleToggleWIN(),
    handleToggleTask: (id) => handleToggleTask(id),
    handleRemoveTask: (id) => handleRemoveTask(id),
    setNewTaskText: (val) => setNewTaskText(val),
    handleAddOtherTask: () => handleAddOtherTask(),
    ...
    newTaskText,
    scorecard,
    handleSaveScorecard: () => handleSaveScorecard(),
    isSavingScorecard,
    streakCount,
    reflectionGood,
    reflectionBetter,
