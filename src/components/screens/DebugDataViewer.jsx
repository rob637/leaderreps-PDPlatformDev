                ...
                <div className="md:col-span-2">
                    <Card title="Global Metadata & Value Sets" icon={Globe} accentColor="bg-corporate-teal">
                        ...
                        <textarea
                            ...
                            className="w-full p-3 font-mono text-[10px] leading-tight border border-slate-300 rounded-xl bg-slate-50 shadow-inner resize-y focus:outline-none focus:ring-2 focus:ring-corporate-teal"
