      ...
      <div className="max-w-3xl mx-auto">
        ...
        <Card accentColor="bg-corporate-teal" className="mb-8">
          <div className="text-center py-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-emerald-50 dark:bg-emerald-900/20 mb-5">
            ...
            <p className="text-slate-500 dark:text-slate-400 mb-5">All features included at no cost</p>
            <div className="inline-block bg-emerald-50 dark:bg-emerald-900/20 text-emerald-700 px-5 py-2 rounded-full font-medium text-sm">
              ✓ Active
            </div>
          </div>
        </Card>
