...
// >>> 1. NEW IMPORT: Import the ExecutiveReflection component
import ExecutiveReflection from './Reflection.jsx'; 

// Icons used in the new NavSidebar
import { Home, Zap, ShieldCheck, TrendingUp, Mic, BookOpen, Settings, X, Menu, LogOut, CornerRightUp, Clock, Briefcase, Target, Users, BarChart3, HeartPulse, Star } from 'lucide-react';
...
const NavSidebar = ({ currentScreen, setCurrentScreen, user, isMobileOpen, closeMobileMenu }) => {
    ...
    const coreNav = [
        ...
        // >>> 3. ADDED REFLECTION LINK TO CORE NAV
        { screen: 'reflection', label: 'Executive Reflection', icon: Star },
    ];
...
const ScreenRouter = ({ currentScreen, navParams }) => {
  switch (currentScreen) {
    // >>> 2. NEW ROUTE: Add the 'reflection' case
    case 'reflection':
