      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl p-6 text-white shadow-lg">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
            <div className="flex justify-between items-center">
              ...
              <button className="bg-white text-blue-700 px-4 py-2 rounded-lg font-bold hover:bg-blue-50 transition-colors">
                Register Now
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-xl font-bold text-gray-800 mb-4">On-Demand Coaching</h3>
            <div className="space-y-3">
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer flex items-center gap-3">
                <div className="w-10 h-10 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center">🤖</div>
                <div>
                  <div className="font-bold text-gray-700">AI Feedback Coach</div>
                  <div className="text-xs text-gray-500">Practice anytime</div>
                </div>
              </div>
              <div className="p-3 border rounded hover:bg-gray-50 cursor-pointer flex items-center gap-3">
                <div className="w-10 h-10 bg-orange-100 text-orange-600 rounded-full flex items-center justify-center">👤</div>
                <div>
                  <div className="font-bold text-gray-700">Request 1:1 Coaching</div>
          ...
          {/* My Coaching */}
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-xl font-bold text-gray-800 mb-4">My Coaching</h3>
