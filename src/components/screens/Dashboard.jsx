  ...
  const renderers = {
    ...
    'identity-builder': () => (
      <WidgetRenderer widgetId="identity-builder" scope={scope}>
        <Card title="Identity Builder" icon={Flame} className="border-t-4 border-[#E04E1B] h-full">
    ...
    'habit-stack': () => (
      <WidgetRenderer widgetId="habit-stack" scope={scope}>
        <Card title="Habit Stack" icon={Layers} className="border-t-4 border-[#002E47] h-full">
          <div className="space-y-3 text-left">
            {dailyRepName ? (
    ...
    'win-the-day': () => (
      <WidgetRenderer widgetId="win-the-day" scope={scope}>
        <Card title="AM Bookend - Win the Day" icon={Sun} className="border-t-4 border-[#47A88D] h-full">
    ...
    'notifications': () => (
      <WidgetRenderer widgetId="notifications" scope={scope}>
        <Card title="Notifications" icon={Bell} className="border-t-4 border-[#E04E1B] h-full">
          <div className="space-y-3 text-left">
    ...
    'scorecard': () => (
      <WidgetRenderer widgetId="scorecard" scope={scope}>
        <Card title="Today Scorecard" icon={Clipboard} className="border-t-4 border-[#47A88D] h-full">
    ...
    'pm-bookend': () => (
      <WidgetRenderer widgetId="pm-bookend" scope={scope}>
        <Card title="PM Bookend - Reflection" icon={Moon} className="border-t-4 border-[#002E47] h-full">
          <div className="space-y-4">
            <div>
