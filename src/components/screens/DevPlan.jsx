...
// Map tier icon names to actual Lucide components
const IconMap = { HeartPulse, Mic, Briefcase, Users, TrendingUp, Target };
...
const TrackerDashboardView = ({ data, updatePdpData, saveNewPlan, db, userId, navigate }) => {
    ...
    const TierIcon = (LEADERSHIP_TIERS[currentTierId]?.icon && IconMap[LEADERSHIP_TIERS[currentTierId].icon]) ? IconMap[LEADERSHIP_TIERS[currentTierId].icon] : Target;
