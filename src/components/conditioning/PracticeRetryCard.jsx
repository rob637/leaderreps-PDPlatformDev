  ...
  return (
    <Card className="border-l-4 border-l-corporate-navy">
      <div className="p-4">
        ...
        {/* Practice Prompt */}
        <div className="mb-4">
          <p className="text-sm text-gray-700 font-medium mb-1">Your Practice Challenge:</p>
          <p className="text-corporate-navy italic bg-gray-50 p-3 rounded-lg">
            "{prompt}"
          </p>
        </div>
        ...
        {retry.context?.originalResponse && (
          <div className="mb-4">
            <p className="text-sm text-gray-600 mb-1">Your original response:</p>
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            rows={4}
            className="w-full p-3 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-corporate-navy focus:border-corporate-navy"
          />
        </div>
          ...
          {retries.map((retry) => {
            ...
            return (
              <button
                ...
                className="w-full flex items-center gap-3 p-3 bg-white rounded-lg border border-amber-200 hover:border-amber-400 transition-colors text-left"
              >
