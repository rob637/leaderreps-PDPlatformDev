      ...
      <div className="space-y-3 text-xs">
        <div className="grid grid-cols-2 gap-2">
          <div className="p-2 bg-slate-50 rounded border border-slate-100">
            <div className="font-bold text-slate-500">Current Date</div>
            <div className="text-slate-800">{simulatedNow.toLocaleDateString()}</div>
          </div>
          <div className="p-2 bg-slate-50 rounded border border-slate-100">
            <div className="font-bold text-slate-500">Day Number</div>
        ...
        {currentDayNumber > 0 && (
          <div className="flex items-start gap-2 p-2 bg-red-50 text-red-700 rounded border border-red-100">
