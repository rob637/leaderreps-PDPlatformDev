...
const LeaderProfileFormSimple = ({ onComplete, onClose, isModal = true }) => {
  ...
  return (
    <div ref={formRef} className={isModal ? 'bg-white dark:bg-slate-800 rounded-xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col w-full max-h-[70dvh] sm:max-h-[85vh] min-h-[50vh]' : ''}>
