      ...
      <div 
        className={cn(
          ...
          checked 
            ...
            : "border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 group-hover:border-corporate-teal/50"
        )}
      >
      ...
      <div className="flex-1">
        {label && (
          <p className={cn(
            ...
            checked ? "text-teal-900" : "text-slate-700 dark:text-slate-200"
          )}>
            {label}
          </p>
        )}
