...
export const FEATURE_METADATA = {
  ...
  'dev-plan-timeline': { core: true, category: 'Development Plan', name: 'Plan Timeline', description: 'Plan Timeline', purpose: 'Visual timeline.', extendedDescription: 'A visual timeline showing the progression of the development plan.' },
  'dev-plan-details': { core: true, category: 'Development Plan', name: 'Plan Details', description: 'Plan Details', purpose: 'Detailed view.', extendedDescription: 'A detailed breakdown of the development plan structure and content.' },
